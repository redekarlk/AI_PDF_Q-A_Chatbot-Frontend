...
//   >
//     <div
//       className={`max-w-[80%] p-3 rounded-xl shadow-lg text-sm backdrop-blur-sm ${sender === "user"
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-black text-white font-sans">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-gray-900/30 border-b border-gray-700/30">
        <div className="max-w-7xl mx-auto flex justify-between items-center h-16 px-4 sm:px-6">
          <Link href="/" className="text-2xl font-extrabold bg-gradient-to-r from-purple-400 to-teal-300 bg-clip-text text-transparent" aria-label="Go to homepage">
            PDF Query AI
          </Link>
      ...
      {/* FEATURES */}
      <section className="py-16 px-4 sm:px-6 bg-black/70">
